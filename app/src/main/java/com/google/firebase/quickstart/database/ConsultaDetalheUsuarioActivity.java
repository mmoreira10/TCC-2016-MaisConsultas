...
public class ConsultaDetalheUsuarioActivity extends BaseActivity implements View.OnClickListener {

    private static final String TAG = "ConsultaDetalheUsuarioActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consulta_detalhe_usuario);
        ...
        imgFoto = (ImageView) findViewById(R.id.fotoUsuario);
        imgFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent foto = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                startActivityForResult(foto, GALERIA);
            }
        });
    ...
    public void onStart() {
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(ConsultaDetalheUsuarioActivity.this, "Ops! Falha ao carregar suas consultas.",
    ...
    private static class CommentAdapter extends RecyclerView.Adapter<CommentViewHolder> {
        ...
        public CommentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = inflater.inflate(R.layout.item_obs_usuario, parent, false);
