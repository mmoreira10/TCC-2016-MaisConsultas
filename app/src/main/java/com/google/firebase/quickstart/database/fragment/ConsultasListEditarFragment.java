...
import com.google.firebase.quickstart.database.NovaConsultaUsuario;
...
public abstract class ConsultasListEditarFragment extends Fragment {

    private static final String TAG = "ConsultasListEditarFragment";
    ...
    public ConsultasListEditarFragment() {
    }
            ...
            protected void populateViewHolder(final ConsultasViewHolder viewHolder, final Consultas model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent editar = new Intent(getActivity(), NovaConsultaUsuario.class);
