...
public abstract class ConsultasListFragment extends Fragment{

    private AlertDialog alerta;//atributo da classe.

    private static final String TAG = "ConsultasListFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_todas_consultas, container, false);

        // Inicia o BD.
        mDatabase = FirebaseDatabase.getInstance().getReference();
        // Finaliza a declaração do BD.

        mRecycler = (RecyclerView) rootView.findViewById(R.id.consultas_list);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Consultas, ConsultasViewHolder>(Consultas.class, R.layout.item_consulta,
            ...
            protected void populateViewHolder(final ConsultasViewHolder viewHolder, final Consultas model, final int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(getActivity(), ConsultaDetalheActivity.class);
